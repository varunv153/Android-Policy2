...
data class Policy(var id:Int, var policywording:String, var roomrentcap:Int, var suminsured:Int, var company_adminemail:String, var exemptions:String, var claim_settlement_ratio:Double)